...
if __name__ == '__main__':
  ...
  squirtImage = SquirtImages()
  charImages = CharImages()
  charFront = charImages[0]
  
  charButton = Button()
  charButton.assignImage(charFront)
  charButton.setCoords(50, 50)
  squirtButton = Button()
  squirtButton.assignImage(charFront)
  squirtButton.setCoords(50, 50)
  bulbButton = Button()
  bulbButton.assignImage(charFront)
  bulbButton.setCoords(50, 50)
